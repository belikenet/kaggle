...
Ticket fare mainly depends on ticket class and number of passengers travelling on the same ticket. 
But also, children paid less for the ticket, there were family tickets to make the travel affordable to all kind of families.
Finally, the ticket also cover the trip from the origin city to the port.
</div>
